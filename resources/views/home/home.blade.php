        ...
        <section id="faq" class="faq section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <ul class="faq-list">
                    ...
                    <li>
                        <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">How does the algorithm work
                    ...
                    <li>
                        <div data-bs-toggle="collapse" href="#faq3" class="collapsed question">Is the algorithm in
                    ...
                    <li>
                        <div data-bs-toggle="collapse" href="#faq4" class="collapsed question">Is "LoveHeart" free?<i
                                class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                    ...
                    <li>
                        <div data-bs-toggle="collapse" href="#faq5" class="collapsed question">Will "LoveHeart" store
                    ...
                    <li>
                        <div data-bs-toggle="collapse" href="#faq6" class="collapsed question">Can "LoveHeart" be used
